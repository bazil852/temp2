...
export function PinnedMessages({
  ...
  return (
    <div className="mb-6">
      <div className="sticky top-0 bg-[#1f2937] z-10 backdrop-blur-md rounded-lg">
        <div className="flex items-center gap-2 bg-[#c9fffc] p-4 rounded-lg">
          <Pin className="w-5 h-5 text-gray-900" />
          <span className="text-sm font-medium text-gray-900 underline decoration-gray-900/30">Pinned Messages</span>
        </div>
